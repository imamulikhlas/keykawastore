...
<div class="p-4 flex flex-wrap gap-2 bg-slate-50 rounded-t-lg -mt-8">
    ...
    <div class="rounded-b-lg -mt-6 bg-white shadow-md mb-4 w-full p-3">
        <div class="w-full -mt-14">
            <img src="https://assets.jajangame.com/2022/11/9ef252294c4a6f9c39cb3a44926b5c9a.png"
                style="width: 80px" class="mx-auto rounded-lg shadow" alt="">
        </div>
    ...
    <form class="w-full">
        <div class="rounded-lg bg-white shadow-md mb-4 animate__animated animate__fadeInUp">
            ...
            <div class="px-3 -mt-2 mb-2"
                ...
                <div class="flex">
                    ...
                    <input class="w-8 border text-center focus:outline-none text-xs h-8" type="number"
            ...
            <div v-if="operator.helper_image" class="px-3 py-1">
                <button @click.prevent="showPetunjuk=true"
                    class="text-xs px-4 py-2 rounded-md bg-primary text-white">
        ...
        <div v-if="product[0].tipe===1"
            class="rounded-lg bg-white shadow-md mb-4 animate__animated animate__fadeInUp">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 p-3 gap-3">
                <div v-for="(pr,i) in product" :key="i"
                    @click.prevent="pr.status !== 0 ? selectedProduct=pr : ''"
                ...
                <div class="grid grid-cols-1 p-4 gap-3 cursor-pointer ">
                    <div v-for="(pay,i) in sortedPayment" :key="i" class="border-2 rounded-lg">
                        ...
                        <div v-show="selectedPayment.id===pay.kategori.id"
                            ...
                            <div v-for="(mt, i) in pay.metode"
                                class="p-3 w-full relative rounded-lg border-2"
                                @click.prevent="isOpen(mt.open_hour, mt.close_hour) === 'OPEN'?selectPay(mt):''"
                                :class="mt.id_metode === order.metode_id ? 'border-secondary' : isOpen(mt.open_hour, mt
                                ...
                                <div class="absolute bottom-0 right-0 "
                                    v-if="mt.id_metode === order.metode_id ">
                                    <div class="py-1 px-2 bg-secondary rounded-br-md rounded-tl-md text-white
                    ">
                                        <i class="fas fa-check text-xs"></i>
                                    </div>
        ...
        <div class="rounded-lg bg-white shadow-md mb-4 animate__animated animate__fadeInUp">
            ...
            <div class="grid grid-cols-1 p-3 gap-3">
                <div>
                    ...
                    <input required :disabled="me.user_code"
                        :class="me.user_code ? 'bg-gray-200 text-gray-500' : ''"
        ...
        <div class="h-24"></div>
        <div v-if="isOpen(jenis.open_hour, jenis.close_hour)==='OPEN'"
            class="fixed bottom-0 left-0 w-full bg-primary">
